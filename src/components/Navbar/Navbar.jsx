...
const Navbar = ({ toggleMobileSidebar }) => {
    return (
        <nav className='bg-[#FCFCFC] flex items-center justify-between border-l-[1px] border-[#CFD3D8] py-6 px-10 max-sm:px-5 w-full'>
            ...
            <div className='flex gap-x-28 max-md:gap-x-10'>
                <div className='flex items-center gap-x-2.5 max-lg:hidden'>
                    <div className="relative w-[269px] transition-all">
                        <input
                            type="text"
                            placeholder="Search..."
                            id="searchInput"
                ...
                <div className='flex items-center gap-x-6 max-sm:gap-x-4'>
                    <div className="relative p-2 rounded-lg">
                        ...
                        <div className="px-1 py-0.5 bg-[#FF6A55] min-w-5 rounded-full text-center text-white text-xs absolute -top-1 right-1 -end-1 translate-x-1/4 text-nowrap">
                            <div className="absolute top-0 start-0 rounded-full -z-10 animate-ping bg-[#FF6A55] w-full h-full"></div>
                            3
                        </div>
                    </div>
